  ...
  const slider_items = [
    {
      ...
      alt: "",
      link: "/",
      title: "AI Based NFT Creation",
      description: "Create unique and original NFTs using cutting-edge artificial intelligence technology.",
    },
    {
      src: icon02,
      alt: "",
      link: "/",
      title: "Monetize your NFT's",
      description: "Monetize your artwork and creativity through the NFT marketplace.",
    },
    {
      src: icon03,
      alt: "",
      link: "/",
      title: <>Biggest Communitiy</>,
      description: "Connect with a growing community of artists, collectors, and enthusiasts in the world of NFTs.",
    },
    {
      src: icon04,
      alt: "",
      ...
      description: "Benefit from a secure and decentralized platform for buying, selling, and trading NFTs.",
    },
    {
      src: icon01,
      alt: "",
